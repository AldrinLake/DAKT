...
class iCIFAR100(iData):
    ...
    def download_data(self):
        train_dataset = datasets.cifar.CIFAR100("../../datasets", train=True, download=False)
        test_dataset = datasets.cifar.CIFAR100("../../datasets", train=False, download=False)
        self.train_data, self.train_targets = train_dataset.data, np.array(
            train_dataset.targets
        )
        self.test_data, self.test_targets = test_dataset.data, np.array(
...
class iImageNet1000(iData):
    ...
    def download_data(self):
        ...
        train_dir = "../../../../../common/ImageNet/ImageNet2012/train/"
        test_dir = "../../../../../common//IMAGENET_2012/val/"
...
class iImageNet100(iData):
    ...
    def download_data(self):
        #assert 0, "You should specify the folder of your dataset"
        train_dir = "../../datasets/imagenet100/train/"
        test_dir = "../../datasets/imagenet100/val/"
...
class iCARS(iData):
    ...
    def download_data(self):
        # train_dataset = datasets.StanfordCars(root="../../datasets/", split='train', download=False)
        # test_dataset = datasets.StanfordCars(root="../../datasets/", split='test', download=False)
        ...
        # os.makedirs("data_cars", exist_ok=True)
        # torch.save(self.train_data, "data_cars/train_data.pkl")
        # torch.save(self.train_targets, "data_cars/train_targets.pkl")
        ...
        # torch.save(self.test_data, "data_cars/test_data.pkl")
        # torch.save(self.test_targets, "data_cars/test_targets.pkl")

        # Generate pickle files for the first time and re-use the saved pickle files later
        self.train_data = torch.load("data_cars/train_data.pkl")
        self.train_targets = torch.load("data_cars/train_targets.pkl")
        self.test_data = torch.load("data_cars/test_data.pkl")
        self.test_targets = torch.load("data_cars/test_targets.pkl")
